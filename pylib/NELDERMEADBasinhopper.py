# Ed Callaghan
# scipy.basinhopping with nlopt.L_NELDERMEAD at each step... robust, and fast
...
from NLOPTMinimizers import nlopt_f_wrap, L_NELDERMEAD
...
class NELDERMEADBasinhopper(Minimizer):
    def __init__(self, **kwargs):
        BuildObject(self, defaults, kwargs)
        super(NELDERMEADBasinhopper, self).__init__(**kwargs)
    ...
    def minimize(self, f, seeds, bounds):
        ...
        local_minimizer = L_NELDERMEAD(ftol_rel=self.local_ftol_rel,
